...
class BaseConfigTab(nbt.NotebookTab):
    ...
    def __init__(self, parent):
        ...
        #print "SYS_COLOUR_SCROLLBAR = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_SCROLLBAR))
        #print "SYS_COLOUR_BACKGROUND = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BACKGROUND))
        #print "SYS_COLOUR_ACTIVECAPTION = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_ACTIVECAPTION))
        #print "SYS_COLOUR_INACTIVECAPTION = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_INACTIVECAPTION))
        #print "SYS_COLOUR_MENU = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_MENU))
        #print "SYS_COLOUR_WINDOW = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOW))
        #print "SYS_COLOUR_WINDOWFRAME = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWFRAME))
        #print "SYS_COLOUR_MENUTEXT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_MENUTEXT))
        #print "SYS_COLOUR_WINDOWTEXT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT))
        #print "SYS_COLOUR_CAPTIONTEXT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_CAPTIONTEXT))
        #print "SYS_COLOUR_ACTIVEBORDER = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_ACTIVEBORDER))
        #print "SYS_COLOUR_INACTIVEBORDER = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_INACTIVEBORDER))
        #print "SYS_COLOUR_APPWORKSPACE = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_APPWORKSPACE))
        #print "SYS_COLOUR_HIGHLIGHT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_HIGHLIGHT))
        #print "SYS_COLOUR_HIGHLIGHTTEXT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_HIGHLIGHTTEXT))
        #print "SYS_COLOUR_BTNFACE = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BTNFACE))
        #print "SYS_COLOUR_BTNSHADOW = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BTNSHADOW))
        #print "SYS_COLOUR_GRAYTEXT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_GRAYTEXT))
        #print "SYS_COLOUR_BTNTEXT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BTNTEXT))
        #print "SYS_COLOUR_INACTIVECAPTIONTEXT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_INACTIVECAPTIONTEXT))
        #print "SYS_COLOUR_BTNHIGHLIGHT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BTNHIGHLIGHT))
        #print "SYS_COLOUR_3DDKSHADOW = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_3DDKSHADOW))
        #print "SYS_COLOUR_3DLIGHT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_3DLIGHT))
        #print "SYS_COLOUR_INFOTEXT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_INFOTEXT))
        #print "SYS_COLOUR_INFOBK = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_INFOBK))
        #print "SYS_COLOUR_LISTBOX = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_LISTBOX))
        #print "SYS_COLOUR_HOTLIGHT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_HOTLIGHT))
        #print "SYS_COLOUR_GRADIENTACTIVECAPTION = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_GRADIENTACTIVECAPTION))
        #print "SYS_COLOUR_GRADIENTINACTIVECAPTION = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_GRADIENTINACTIVECAPTION))
        #print "SYS_COLOUR_MENUHILIGHT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_MENUHILIGHT))
        #print "SYS_COLOUR_MENUBAR = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_MENUBAR))
        #print "SYS_COLOUR_LISTBOXTEXT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_LISTBOXTEXT))
        #print "SYS_COLOUR_LISTBOXHIGHLIGHTTEXT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_LISTBOXHIGHLIGHTTEXT))
        #print "SYS_COLOUR_MAX = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_MAX))
        #print "SYS_COLOUR_DESKTOP = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_DESKTOP))
        #print "SYS_COLOUR_3DFACE = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_3DFACE))
        #print "SYS_COLOUR_3DSHADOW = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_3DSHADOW))
        #print "SYS_COLOUR_BTNHILIGHT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BTNHILIGHT))
        #print "SYS_COLOUR_3DHIGHLIGHT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_3DHIGHLIGHT))
        #print "SYS_COLOUR_3DHILIGHT = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_3DHILIGHT))
        #print "SYS_COLOUR_FRAMEBK = " + str(wx.SystemSettings.GetColour(wx.SYS_COLOUR_FRAMEBK))
        #print "SYS_MOUSE_BUTTONS = " + str(wx.SystemSettings.GetColour(wx.SYS_MOUSE_BUTTONS))
        #print "--------------------------------------------------------------------------------"
