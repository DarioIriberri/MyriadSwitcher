...
#EVT_MOUSE_CAPTURE_LOST = wx.PyEventBinder( wxEVT_MOUSE_CAPTURE_LOST )
        ...
        #self.wvLogs.Bind(wx.EVT_SET_FOCUS, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_COMMAND_KILL_FOCUS, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_COMMAND_SET_FOCUS, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_LIST_ITEM_FOCUSED, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_LIST_ITEM_DESELECTED, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_LIST_ITEM_MIDDLE_CLICK, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_LIST_ITEM_RIGHT_CLICK, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_LIST_ITEM_ACTIVATED, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_LIST_ITEM_SELECTED, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_KILL_FOCUS, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_CHILD_FOCUS, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_TOGGLEBUTTON, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_ENTER_WINDOW, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_LEAVE_WINDOW, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_SIZE, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_SIZING, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_PAINT, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_ERASE_BACKGROUND, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_ACTIVATE, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_ACTIVATE_APP, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_SYS_COLOUR_CHANGED, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_DISPLAY_CHANGED, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_PALETTE_CHANGED, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_SET_CURSOR, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_MOUSE_CAPTURE_CHANGED, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_MOUSE_CAPTURE_LOST, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_LEFT_DCLICK, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_MOUSE_AUX1_DOWN, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_MOUSE_AUX1_UP, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_MOUSE_AUX1_DCLICK, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_MOUSE_AUX2_DOWN, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_MOUSE_AUX2_UP, self.onFocus)
        #self.wvLogs.Bind(wx.EVT_MOUSE_AUX2_DCLICK, self.onFocus)
#
